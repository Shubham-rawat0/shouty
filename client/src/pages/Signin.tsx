...
function Signin() {
  ...
  // RFC-style practical email regex
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="mt-10 flex items-center justify-center px-25">
            <motion.button
              ...
              className="flex items-center gap-3 justify-center bg-[#fdfdfd] text-[#171717] border-2 border-[#d4d4d4] w-full py-2 rounded-lg cursor-pointer"
            >
              <FaGoogle size={20} />
        ...
        <div className="flex flex-col space-y-5">
          ...
          <div>
            ...
            <div className="relative flex justify-center mt-3 px-25">
              ...
              <button
                ...
                className="absolute right-30 top-1/2 -translate-y-1/2 text-gray-600"
              >
          ...
          <div className="mt-5 flex items-center justify-center px-25">
            <motion.button
              ...
              className="flex items-center gap-3 justify-center bg-[#6bdda6] text-[#171717] border-2 border-[#16b674bf] w-full py-2 rounded-lg cursor-pointer"
            >
      ...
      <div className="w-[60%] bg-[#fcfcfc] flex items-center">
        <div className="relative max-w-md mx-auto px-5">
          ...
          <p className="relative text-4xl text-[#404040] leading-relaxed">
            Shouty is surprisingly simple for a URL shortener. Paste the link,
            get a short URL, done. I like that it doesn’t try to overcomplicate
            things.
          </p>

          <div className="mt-6 flex items-center gap-3">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSxCy61dwjvAEvi33rC8VEPbfwfx-mY3stN4g&s"
              alt="drippinsaul avatar"
              className="h-8 w-8 rounded-full grayscale"
            />
            <p className="text-sm text-[#737373]">@drippinsaul</p>
          </div>
        </div>
      </div>
    </div>
